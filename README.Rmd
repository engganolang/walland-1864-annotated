...
The data table captures the organisation of the remark notes as a [wide table](https://github.com/engganolang/walland-1864-annotated/blob/main/data-output/walland-1864-annotated.csv) and as a [long table](https://github.com/engganolang/walland-1864-annotated/blob/main/data-output/walland-1864-annotated-remark-long.csv) (i.e., that suffixed with `remark-long` in its file name).
